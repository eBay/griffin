...
public class ValidateHiveJobConfig {
	...
	public List<ValidateHiveJobConfigLv1Detail> validityReq;
	public List<PartitionConfig> timePartitions;
	...
	public ValidateHiveJobConfig(String dataSet)
	{
		...
		this.validityReq = new ArrayList<ValidateHiveJobConfigLv1Detail>();
		this.timePartitions = new ArrayList<PartitionConfig>();
	}

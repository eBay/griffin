...
public class ModelTypeConstants {
	...
	public static final int ANOMALY_DETECTION = 2;
	public static final int PUBLISH_METRICS = 3;

	private static final String[] array = {"Accuracy", "Validity", "Anomaly Detection", "Publish Metrics"};

...
import com.ebay.oss.bark.domain.JobStatus;
import com.ebay.oss.bark.domain.ModelStatus;
import com.ebay.oss.bark.domain.ModelType;
import com.ebay.oss.bark.domain.PartitionFormat;
...
import com.ebay.oss.bark.vo.AccuracyHiveJobConfig;
import com.ebay.oss.bark.vo.AccuracyHiveJobConfigDetail;
import com.ebay.oss.bark.vo.PartitionConfig;
import com.ebay.oss.bark.vo.ValidateHiveJobConfig;
...
//				if(readerLV2==null) return;
				...
				if(job==null) {
					...
					return; // FIXME should this be continue???
				}

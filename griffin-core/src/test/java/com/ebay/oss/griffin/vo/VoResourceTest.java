...
public class VoResourceTest {
    ...
    public void testSystemLevelMetricsList() {
        ...
        ml.upsertNewAssetExecute("almName", MetricType.Trend.toString(), 12346L, 18.6f, 2, "system", 0, true, detail);
        ml.upsertNewAssetExecute("almName", MetricType.MAD.toString(), 12346L, 18.6f, 3, "system", 0, true, detail);
        ml.upsertNewAssetExecute("almName", "", 12346L, 18.6f, 5, "system", 0, true, detail);
        assertEquals(1, ml.getLatestDQList().size());
        ml.upsertNewAssetExecute("almName2", MetricType.Bollinger.toString(), 12346L, 18.6f, 6, "system", 0, true, detail);
        ml.upsertNewAssetExecute("almName3", MetricType.Trend.toString(), 12346L, 18.6f, 7, "system", 0, true, detail);
        ml.upsertNewAssetExecute("almName4", MetricType.MAD.toString(), 12346L, 18.6f, 8, "system", 0, true, detail);
        ml.upsertNewAssetExecute("almName5", "", 12346L, 18.6f, 9, "system", 0, true, detail);
        assertEquals(1, ml.getLatestDQList().size());
        ml.upsertNewAssetExecute("almName2", "metricType2", 12346L, 18.6f, 10, "system2", 0, true, detail);

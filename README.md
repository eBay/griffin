...
5. Now you can visit UI through your browser, and follow the next steps on web UI [here](https://github.com/eBay/DQSolution/tree/master/bark-doc/dockerUIguide.md).
    ```
